...
def post_analysis():
  ...
  selected_dates = st.sidebar.date_input("Select dates", [min_date, max_date], min_value=min_date, max_value=max_date)

  authors_name = posts_df["author"].unique()
  selected_authors = st.sidebar.multiselect("Select authors", options=authors_name, default=authors_name)
