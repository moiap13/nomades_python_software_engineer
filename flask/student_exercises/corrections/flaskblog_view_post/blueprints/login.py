...
def register():
  ...
  if request.method == "POST" and register_form.validate():
    ...
    users_with_email: list[DocumentSnapshot] = db.collection(u"users").where("email", "==", email).get()
    users_with_uid: list[DocumentSnapshot] = db.collection(u"users").where("uid", "==", uid).get()
...
def login():
  ...
  if request.method == "POST" and login_form.validate():
    ...
    users_with_email: list[DocumentSnapshot] = db.collection(u"users").where("email", "==", uid_email).get()
    users_with_uid: list[DocumentSnapshot] = db.collection(u"users").where("uid", "==", uid_email).get()
