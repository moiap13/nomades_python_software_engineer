...
export default function( revealElement, options ) {
	...
	/**
	 * Returns an my_array of objects where each object represents the
	...
	const API = {
		...
		// Returns an my_array with all horizontal/vertical slides in the deck
		getHorizontalSlides,
		getVerticalSlides,
