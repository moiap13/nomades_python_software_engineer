...
class Point(object):
    ...
    def get_random_point(width, height):
        """
        Pour utiliser cette fonction, appelez la classe Point ensuite le nom de la fonction statique
...
class Snake:
    ...
    ********************************************************************************************************************
    ...
    def __init__(self, color) -> None:
        ...
        self.body = [
            head,
            Point(WIDTH, HEIGHT, head.x-(1*BLOCK_SIZE), head.y),
    ...
    def move(self) -> None:
        ...
        ****************************************************************************************************************
        ...
        # TODO: Update the position of the new_head of the snake according to the current direction.
        ...
        # TODO: Add the new segment at the head of the body of the snake.
    ...
    def change_direction(self, direction: str) -> None:
        ...
        """
        # if self._current_direction == "UP" and direction == "DOWN" \
        #   or self._current_direction == "DOWN" and direction == "UP" \
        #   or self._current_direction == "LEFT" and direction == "RIGHT" \
        #   or self._current_direction == "RIGHT" and direction == "LEFT":
        #       return
        
        # self._current_direction = direction

        unvalid_directions: dict[str, str] = {
            "UP": "DOWN",
            "DOWN": "UP",
            "LEFT": "RIGHT",
            "RIGHT": "LEFT",
        ...
        if unvalid_directions[self._current_direction] == direction:
            return
    ...
    def check_collision(self, item: Food) -> bool:
        ...
        """
        # return self.body[0].x == item.position.x and self.body[0].y == item.position.y
    ...
    def check_border_collision(self) -> bool:
        ...
        return head.x < 0 or head.y < 0 or head.x > WIDTH-BLOCK_SIZE or head.y > HEIGHT-BLOCK_SIZE
    ...
    def draw(self) -> None:
        for segment in self.body:
            pygame.draw.rect(screen, self._color, (segment.x, segment.y, BLOCK_SIZE, BLOCK_SIZE))

# Create instances of Snake and Food - Global variables
snake = Snake(GREEN)
snake2 = Snake(BLUE)

foods: list[Food] = [Food(snake) for _ in range(10)]
...
def update_snake_direction(event, up_key, down_key, left_key, right_key, snake):
    if event == up_key:
  ...
  while running:
      ...
      for event in pygame.event.get():
          if event.type == pygame.QUIT:
              ...
              update_snake_direction(event.key, pygame.K_UP, pygame.K_DOWN, pygame.K_LEFT, pygame.K_RIGHT, snake) 
              update_snake_direction(event.key, pygame.K_w, pygame.K_s, pygame.K_a, pygame.K_d, snake2) 
