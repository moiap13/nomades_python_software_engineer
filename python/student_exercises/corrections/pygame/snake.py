...
class Snake:
    ...
    ********************************************************************************************************************
    ...
    def __init__(self) -> None:
        ...
        self.body = [Point(WIDTH, HEIGHT, head.x-i*BLOCK_SIZE, head.y) for i in range(3)]
    ...
    def check_border_collision(self) -> bool:
        ...
        # return head.x not in range(WIDTH-BLOCK_SIZE, BLOCK_SIZE) or head.y not in range(HEIGHT-BLOCK_SIZE, BLOCK_SIZE)
