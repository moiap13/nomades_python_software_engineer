...
class Snake:
    ...
    ********************************************************************************************************************
    ...
    body: list[Point] = []
    _color: tuple[int, int, int] = BLACK
    ...
    def move(self) -> None:
        ...
        ****************************************************************************************************************
        ...
        # self.body = ([new_head] + self.body).pop()
    ...
    def change_direction(self, direction: str) -> None:
        ...
        """
        # if self._current_direction == "DOWN" and direction != "UP" \
        #   or self._current_direction == "UP" and direction != "DOWN"\
        #   or self._current_direction == "LEFT" and direction != "RIGHT"\
        #   or self._current_direction == "RIGHT" and direction != "LEFT":
        #     self._current_direction = direction

        invalid_directions: dict[str, str] = {
            "UP": "DOWN",
            "DOWN": "UP",
            "LEFT": "RIGHT",
            "RIGHT": "LEFT",
        ...
        if invalid_directions[self._current_direction] != direction:
            self._current_direction = direction
    ...
    def check_border_collision(self) -> bool:
        ...
        """
        # if self.body[0].x < 0 or self.body[0].x > WIDTH or self.body[0].y < 0 or self.body[0].y > HEIGHT:
        #     return True
        # else:
        #     return False
        head: Point = self.body[0].copy()
...
foods: list[Food] = [Food(snake) for _ in range(50)]
