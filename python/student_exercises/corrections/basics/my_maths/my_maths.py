...
def factorial(n: int, max_recurs=100) -> int:
    """
    ...
    if max_recurs == 0:
        raise ValueError("Maximum recusrions attepts")
    ...
    if n == 0 or n == 1:
        return 1
    return n * factorial(n-1, max_recurs=max_recurs-1)
        

def fibonacci(n: int) -> int: # O(n)
    """
