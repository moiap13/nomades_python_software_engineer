...
def read_sales_data() -> list[list[int|str] | dict[str, int|str]]:
    """
    ...
    """
    sales_path: str = CURRENT_DIR + "/sales_data.csv"
    sales_data: list[list[int|str] | dict[str, int|str]] = []
    return sales_data
...
def calculate_total_sales(sales_data: list[list[int|str] | dict[str, int|str]]) -> float | int:
    """
...
def main():
    # Read sales data
    sales_data: list[list[int|str] | dict[str, int|str]] = read_sales_data()
