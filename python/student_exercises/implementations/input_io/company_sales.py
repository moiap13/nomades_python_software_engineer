...
def read_sales_data() -> list[dict[str, str|float|int] | list[str|float|int]]:
    """
...
def read_employee_data() -> list[dict[str, str|float|int] | list[str|float|int]]:
    """
    ...
    """
    # TODO: create employee data path`
    employee_data = []
    return employee_data


def calculate_total_sales(sales_data: list[dict[str, str|float|int] | list[str|float|int]]):
    """
